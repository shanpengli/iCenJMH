...
// getEC
Rcpp::List getEC(const Eigen::Map<Eigen::VectorXd>& beta, const Eigen::Map<Eigen::VectorXd>& tau, const Eigen::Map<Eigen::VectorXd>& gamma, const Eigen::Map<Eigen::VectorXd>& alpha, const Eigen::Map<Eigen::MatrixXd>& H0Y, const Eigen::Map<Eigen::MatrixXd>& Sig, const Eigen::Map<Eigen::MatrixXd>& X1, const Eigen::Map<Eigen::MatrixXd>& Z, const Eigen::Map<Eigen::MatrixXd>& W, const Eigen::Map<Eigen::VectorXd>& Y, const Eigen::Map<Eigen::MatrixXd>& X2, const Eigen::Map<Eigen::VectorXd>& survtime, const Eigen::Map<Eigen::VectorXd>& status, const Eigen::Map<Eigen::VectorXd>& ni, const Eigen::Map<Eigen::VectorXd>& nt, const Eigen::Map<Eigen::MatrixXd>& xsmatrix, const Eigen::Map<Eigen::MatrixXd>& wsmatrix, const Eigen::Map<Eigen::MatrixXd>& pSLR, Eigen::Map<Eigen::MatrixXd>& Psl, Eigen::Map<Eigen::VectorXd>& FUNENW, Eigen::Map<Eigen::MatrixXd>& FUNEBNW, Eigen::Map<Eigen::MatrixXd>& FUNEBSNW, Eigen::Map<Eigen::VectorXd>& FUNE, Eigen::Map<Eigen::MatrixXd>& FUNBW, Eigen::Map<Eigen::MatrixXd>& FUNBWE, Eigen::Map<Eigen::MatrixXd>& FUNBWSE, Eigen::Map<Eigen::MatrixXd>& FUNBWS, const double pStol);
