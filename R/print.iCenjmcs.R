##' Print contents of iCenjmcs object.
##'
##'
##' @title Print iCenjmcs
##' @param x Object of class 'iCenjmcs'.
##' @param ... Further arguments passed to or from other methods.
##' @seealso \code{\link{iCenjmcs}}
##' @author Shanpeng Li
##' @export
##'
print.iCenjmcs <- function(x, digits = 4, ...) {
  if (!inherits(x, "iCenjmcs"))
    stop("Not a legitimate \"iCenjmcs\" object")
