...
##' @param sdata a survival data frame with an interval-censored event outcome.
...
##' @param iCen.formula a formula object for the interval-censored initial event.
##' @param iCen.include a logical value to include the initial event as a covariate. Default is TRUE.
...
iCenjmcs <- function(sdata = NULL, ydata = NULL, cdata = NULL,
                iCen.formula = NULL,
                iCen.include = TRUE,
                long.formula = NULL,
                surv.formula = NULL,
